...
const dict: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "chat.image": "图片",
    "chat.imageUnsupported": "当前模型不支持图片分析，请切换到支持图片识别的模型后再上传图片。",
  ...
  en: {
    ...
    "chat.image": "Image",
    "chat.imageUnsupported": "The current model does not support image analysis. Switch to a vision-capable model before uploading images.",
